...
import { IRuntimeBreakpoint, FileAccessor, RuntimeVariable, timeout, IRuntimeVariableType } from './mockRuntime';
import { createRuntime, createSocketRuntime, RuntimeLike } from './runtimeSelector';
...
export class MockDebugSession extends LoggingDebugSession {
    ...
    public constructor(fileAccessor: FileAccessor) {
		...
		// Refresh variables when runtime notifies a change
		(this._runtime as any).on?.('variablesChanged', () => {
	...
	protected async setExceptionBreakPointsRequest(response: DebugProtocol.SetExceptionBreakpointsResponse, args: DebugProtocol.SetExceptionBreakpointsArguments): Promise<void> {
		...
		// cache and apply to current runtime
		this._exceptionFilterCache = { namedException, otherExceptions };
	...
	protected setVariableRequest(response: DebugProtocol.SetVariableResponse, args: DebugProtocol.SetVariableArguments): void {
		...
		if (rv) {
			...
			(this._runtime as any).setLocalVariable?.(args.name, rv.value);
